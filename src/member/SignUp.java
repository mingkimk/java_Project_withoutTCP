...
//				for (int i = 0; i < tfpwd.getText().length(); i++) {
//
//					if (tfpwd.getText().length() != -1 && tfpwd.getText().length() >= 8
//							&& !tfpwd.getText().matches("[0-9|a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힝]*")) {
//						chkpwd.setText("사용가능(특포)");
//					} else if (tfpwd.getText().length() >= 1 && tfpwd.getText().length() < 8
//							&& tfpwd.getText().matches("[0-9|a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힝]*")) {
//						chkpwd.setText("8글자 미만 (특 미포)");
//					} else if (tfpwd.getText().length() >= 1 && tfpwd.getText().length() < 8
//							&& !tfpwd.getText().matches("[0-9|a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힝]*")) {
//						chkpwd.setText("8글자 미만 (특포)");
//					} else if (tfpwd.getText().length() != -1 && tfpwd.getText().length() >= 8
//							&& tfpwd.getText().matches("[0-9|a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힝]*")) {
//						chkpwd.setText("8글자 이상 (특 미포)");
//					}
//
//				}
